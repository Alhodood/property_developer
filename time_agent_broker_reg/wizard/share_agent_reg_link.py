...
class ShareRecordLinkWizard(models.TransientModel):
    _name = 'share.agent.reg.wizard'
    _description = 'Share Record Link Wizard'
    ...
    def default_get(self, fields_list):
        ...
        base_url = self.env['ir.config_parameter'].sudo().get_param('web.base.url')
        res['record_url'] = f"{base_url}/agent/register"
