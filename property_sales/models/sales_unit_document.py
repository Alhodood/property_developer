...
class PropertyUnitSalesDocument(models.Model):
    _name = 'property.sales.unit.document'
    ...
    pdoc_attachment_ids = fields.Many2many(
        ...
        relation='psdoc_attach_rel_unit',
        column1='psdoc_id_unit',
        column2='psattach_id3_unit',
        string="Attachment",
    ...
    def action_verify_doc(self):
        ...
        folder_id = self.property_unit_id.unit_folder_id
    ...
    def mail_reminder(self):
        ...
        for record in self.search([('expiry_date', '!=', False)]):
            name = record.property_unit_id.name
